    ...
    function () {
       ...
       /************************* 积分兑换 *************************/
        ...
        $("#backTask").on("click", function() {
            $(location).attr('href', 'taskPoint.html');
        })
        ...
        function inputWarn(){
            ...
            if(inputValue == "" || inputValue == null){
                warnInfo = "Please enter the amount you need to withdraw.";
                isOk = false; 
            }else if(inputValue < 20){
                warnInfo = "Each withdrawal must be over 20 points.";
                isOk = false;
            }else if(inputValue > point){
                warnInfo = "Exceed available balance.";
                isOk = false;
            }else{
                isOk = true;
            }
        ...
        function updatePoint(){
            ...
            var totalStr = point+ ' Point = ' + itcCount.toString() + ' ITC';
            $("#rate").html(totalStr);
            $("#wPopAvailablePoint").html(point);
            var pointRateItc = 1/ratio + ' Points = 1 ITC';
        ...
        function dismissPop(isAlert){
            ...
            setTimeout(function() {
                $("#wPop").fadeOut(function(){
                    $("#withdrawInputBox").fadeIn(function(){
                        if(isAlert){
                            alert(" Successfully submitting a withdrawal request. \n Withdrawal is usually completed within 3 working days, please wait patiently.");
                        }
                    });
                })
            }, 500)
