$(document).ready(function() {
    ...
    $("#tJoinBtn").on('click', function() {
        window.open('https://t.me/IoTChain_Korea', '_blank')
    })
    ...
    function updatePage(data) {
        ...
        $("#mailInfo").on('click', function() {
            $(location).attr('href', 'withdrawKn.html')
        })
                    ...
                    if (response.status == 'connected') {
                        FB.api('/me', { locale: 'en_US', fields: 'name, email' }, function(response) {
                            if (response.id != undefined) {
                                ...
                                alert('Facebook 계정을 바인딩하지 못했습니다.')
                            }
                        });
                    } else {
                        alert('Facebook 계정을 바인딩하지 못했습니다.')
        ...
        if (taskInfo.facebookShared == true) {
            ...
            $.getScript('https://connect.facebook.net/en_US/sdk.js', function() {
                ...
                $("#fShareBtn").on('click', function() {
                    if (taskInfo.facebookId == '') {
                        alert('먼저 페이스 북 계정을 묶어주십시오.')
                    } else {
                        var canDoTask = true;
                        if (canGetPoint == false) {
                            var confirmRes = confirm('오늘의 포인트는 배포 완료되었습니다. 미션을 완성해도 포인트를 받아갈 수 없습니다.')
                            if (confirmRes == true) {
                                canDoTask = true;
                            } else {
                                canDoTask = false
        ...
        /***********invite************/
        $("#inviteLink").html('https://Bounty.iotchain.io/registerKn.html?inviterCode=' + privateCode)
        //copy inviteLink
